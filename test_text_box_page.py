...
def test_fill_forms_on_text_box_page(browser):
    ...
    assert 'Artem.Alenin' == text_box_page.find_element(TextBoxPageLocators.NAME_OUTPUT).text
    assert 'Artem.Alenin@test.ru' == text_box_page.find_element(TextBoxPageLocators.EMAIL_OUTPUT).text
    assert 'City of Kursk' == text_box_page.find_element(TextBoxPageLocators.CURRENT_ADDRESS_OUTPUT).text
    assert 'Kosinovo village' == text_box_page.find_element(TextBoxPageLocators.PERMANENT_ADDRESS_OUTPUT).text
