...
def test_resizable(browser):
    ...
    test_resizable.field_slide('first', random.randint(150, 500), random.randint(150, 300))
    test_resizable.simple_pause(1)
    test_resizable.field_slide('second', random.randint(20, 300), random.randint(20, 300))
    test_resizable.simple_pause(1)
