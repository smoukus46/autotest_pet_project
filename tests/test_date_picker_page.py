...
def test_date_picker(browser):
    ...
    test_date_picker.open_select_date_dropdown()
    test_date_picker.select_date()
    test_date_picker.open_date_and_time_dropdown()
    test_date_picker.select_date_and_time()
